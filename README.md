...
| --------- | --------- | --------- |
| Blockchain Document Archival System | Permissioned Hyperledger Fabric network (3 rogs) + private IPFS swarm, RBAC enforced at chaincode/API/UI, governance-aware approval workflow, Redis cross-node sessions | Private |
...
- Research-inspired or data-driven applications
...
## ⚡ Fun Fact
I blend **web development and cybersecurity** to build systems that are not just functional — but **secure, auditable, and future-proof**.
