...
**Software Development Life Cycle (SDLC)** — for client-facing and production systems.
Planning → Requirements → Design → Implementation → Testing → Deployment → Maintenance.
I follow this end-to-end for web applications, ensuring each phase is documented, testable, and deployable with minimal risk.

**Design Science Research (DSR)** — for research-driven and innovation projects.
Problem identification → Design & development of an artifact → Evaluation → Communication.
I apply this for academic and applied research projects where the deliverable is a novel system or framework — such as my master's thesis on blockchain-based archival integrity.

Both methodologies share a common principle I carry into every project: **build with intention, validate with evidence, and document for the next person.**
...
Freelancing, to me, is the shortest path between an idea and something real.

I take full ownership of every challenge — and seeing the direct impact of that work,
knowing that it matters to a real person beyond any sprint board or ticket queue,
is what drives me.

The freedom to work from anywhere and the income potential don't hurt either. 🤣
